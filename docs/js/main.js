...
function initMap() {
  ...
  L.marker([55.751, 37.65])
    .addTo(map)
    .bindPopup('Языковое кафе Lingua');

  L.marker([55.740, 37.62])
    .addTo(map)
    .bindPopup('Языковое кафе Lingua');

  L.marker([55.761, 37.60])
    .addTo(map)
    .bindPopup('Языковое кафе Lingua');

  L.circle([55.74, 37.64], {
    radius: 600,
    color: '#0d6efd',
    fillColor: '#0d6efd',
    fillOpacity: 0.15
    ...
    .addTo(map)
    .bindPopup('Языковой комплекс Lingua');
}
